<?php
	...
	trait Post {
		public function post(bool $success, string $message = null, Array $data = null, Classes\PostReturnAction $returnAction = null, $exportFields = null) : void {
			$props = $this->getHttpProps($success, [] );
